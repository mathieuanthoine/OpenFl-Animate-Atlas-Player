...
import starling.extensions.animate.AnimationAtlasFactory;
 ...
 *
 *  <strong>BitmapData Properties</strong>
 *
...
class AssetManager extends EventDispatcher
{
    ...
    private function getNameFromUrl(url : String) : String
    {
        if (url != null)
        {
            //var matches : Array<Dynamic> = NAME_REGEX.exec(decodeURIComponent(url));
...
class AssetPostProcessor
{
    ...
    @:allow(starling.assets.AssetManager)
