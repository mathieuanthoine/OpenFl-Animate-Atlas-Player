 ...
 *    <li>Any Stage3D texture has to have side lengths that are powers of two. animateAtlasPlayer hides 
 ...
 *  limitation. All textures are within one big "super-texture", and animateAtlasPlayer takes care that 
 ...
 *  script that is bundled with animateAtlasPlayer's sibling, the <a href="http://www.sparrow-framework.org">
 ...
 *  Texture Packer</a>.</p>
 *  
 *  <p>Whatever tool you use, animateAtlasPlayer expects the following file format:</p>
 * 
 *  <listing>
 ...
 *  has been rotated by 90 degrees, clockwise. animateAtlasPlayer will undo that rotation by rotating
